    ...
    <div className="cosplay-page">
      <div id="top" className="container">
        ...
        <p className="intro-text">
          I love to create fun costumes for cosplay using what I've learned from my engineering background. One of which
          cosplays comes from a game called Pokémon where I created the tail of legendary Pokémon called "Zeraora".
        </p>
        ...
        <section id="process" className="content-section">
          ...
          <p className="section-text">
            Creating a 3D printed cosplay prop involves several steps, from concept to final product. Here's my process
            for creating the Zeraora tail:
          </p>
          ...
          <div className="materials-grid">
            <div className="material-box">
              ...
              <p className="box-text">
                For the Zeraora tail, I primarily used PLA filament due to its ease of printing and rigidity. The bright
                yellow color was perfect for this Pokémon character, and the material holds detail well.
              </p>
            </div>
            <div className="material-box">
              <h3 className="box-title">Design Software</h3>
              <p className="box-text">
                I used SOLIDWORKS for the initial design, leveraging my engineering background to create a structurally
                sound model that could be worn comfortably while maintaining the character's aesthetic.
              </p>
            </div>
            <div className="material-box">
              <h3 className="box-title">Printing Equipment</h3>
              <p className="box-text">
                The tail was printed on a smaller printer with a build volume of 16.14 x 16.14 x 18.31 inches. I had to
                design the tail to have multiple parts that could be glued together to create the complete tail.
              </p>
            </div>
            <div className="material-box">
        ...
        <section id="tableau" className="content-section">
          ...
          <p className="tableau-intro">
            While not directly related to 3D printing, here's an interactive visualization of Oregon's Respiratory Virus
            Data:
          </p>
